...
export async function getCourses(teacherId?: string): Promise<Course[]> {
  try {
    ...
    console.error("[Data Fetch] Error fetching courses:", error)
    return []
  }
}
...
export async function getStudentStats(): Promise<StudentStats | null> {
  try {
    ...
    console.error("[Data Fetch] Error fetching student stats:", error)
    return null
  }
}
...
export async function getForumPosts(): Promise<ForumPost[]> {
  try {
    ...
    console.error("[Data Fetch] Error fetching forum posts:", error)
    return []
  }
}
...
export async function getLeaderboard(limit = 10) {
  try {
    ...
    console.error("[Data Fetch] Error fetching leaderboard:", error)
    return []
  }
}
...
export async function getBadges(): Promise<Badge[]> {
  try {
    ...
    console.error("[Data Fetch] Error fetching badges:", error)
    return []
  }
}
...
export async function getRecentActivity() {
  try {
    ...
    console.error("[Data Fetch] Error fetching activity logs:", error)
    return []
  }
}
...
export async function getWeeklyProgress() {
  try {
    ...
    console.error("[Data Fetch] Error fetching weekly progress:", error)
    return []
  }
}
...
export async function getTeacherStats(teacherId?: string) {
  try {
    ...
    console.error("[Data Fetch] Error fetching teacher stats:", error)
    return {
